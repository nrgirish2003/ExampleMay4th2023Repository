...
public class Assignment7 {
	...
	private static void createTask()
	{
		try {
			...
			Thread.sleep(2000);
			m.findElement(By.xpath("/html/body/div[13]/div[1]")).click();
			Thread.sleep(2000);
			m.findElement(By.xpath("//*[@id=\'createTasksPopup_createTasksTableContainer\']/table/tbody/tr[1]/td[1]/input")).sendKeys("t1");
			Thread.sleep(2000);
			m.findElement(By.xpath("//span[text()='Create Tasks']")).click();
			Thread.sleep(2000);
			m.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[1]/div[2]/div[1]/table[1]/tbody/tr/td[1]/div")).click();
			Thread.sleep(2000);
			m.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[1]/div[3]/div/div/div[4]/span")).click();
			Thread.sleep(4000);
		} catch (Exception e) {
			e.printStackTrace();
		}
